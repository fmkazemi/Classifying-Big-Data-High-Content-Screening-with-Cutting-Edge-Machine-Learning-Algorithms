...
#**import input_data
#matplotlib inline
print("Resnet_224-------------------Resnet_224_101------------------Resnet_224_101-------------------------Resnet_224_101")
...
with slim.arg_scope(resnet_arg_scope()):#with slim.arg_scope(resnet_v1.resnet_arg_scope()):
    net, end_points = resnet_v1_101(inputs=input_layer,num_classes=12,is_training=False) 
...
#            plt.savefig('/gs/project/kek-072-aa/code/result/time_vgg16_224' + str(i) + '.png') 
              plt.savefig('/home/fmkazemi/code/result_Resnet101/time_Resnet101_224' + str(i) + '.png') 
...
#            plt.savefig('/gs/project/kek-072-aa/code/result/entropyloss_vgg16_224' + str(i) + '.png') 
              plt.savefig('/home/fmkazemi/code/result_Resnet101/entropyloss_Resnet101_224' + str(i) + '.png') 
...
#            plt.savefig('/gs/project/kek-072-aa/code/result/test_train_accuracy_vgg16_224' + str(i) + '.png')
              plt.savefig('/home/fmkazemi/code/result_Resnet101/test_train_accuracy_Resnet101_224' + str(i) + '.png')
	    ...
	    #nn_confMatrix = confusion_matrix(np.argmax(yP,1),np.hstack(y))
            ...
            #print(np.argmax(yP,1))
              ...
              np.savetxt('/home/fmkazemi/code/result_Resnet101/ac.txt', a, fmt='%f')
              np.savetxt('/home/fmkazemi/code/result_Resnet101/act.txt', aT, fmt='%f')
              np.savetxt('/home/fmkazemi/code/result_Resnet101/loss.txt', l, fmt='%f')
              np.savetxt('/home/fmkazemi/code/result_Resnet101/time.txt', tnow, fmt='%d')	    	
         i+= 1	
