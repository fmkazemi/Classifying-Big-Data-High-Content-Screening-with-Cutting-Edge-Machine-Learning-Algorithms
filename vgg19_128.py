...
strat_shuffled_split = StratifiedShuffleSplit(label_coded, n_iter=1, test_size=0.15, random_state=23)
...
input_layer = tf.placeholder(shape=[None,128,128,3],dtype=tf.float32,name='input') # 224
...
#        if i % 200 == 0:
            ...
            plt.savefig('/gs/project/kek-072-aa/code/result/time_t128_b' + str(i) + '.png') 
	    ...
	    #pdb.set_trace()
            ...
            plt.savefig('/gs/project/kek-072-aa/code/result/entropyloss_t128_b' + str(i) + '.png') 
...
#            plt.legend((l2, l1), ('test accuracy', 'training accuracy'), loc='upper right', shadow=True)
            ...
            plt.savefig('/gs/project/kek-072-aa/code/result/test_train_accuracy_t128_b' + str(i) + '.png')
